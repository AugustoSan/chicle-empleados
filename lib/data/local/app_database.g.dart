...
class $SalesModelTable extends SalesModel
  ...
  @override
  List<GeneratedColumn> get $columns => [id, status, date, total, userId];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class SalesModelData extends DataClass implements Insertable<SalesModelData> {
  ...
  SalesModelData copyWith(
          {int? id, int? status, DateTime? date, double? total, int? userId}) =>
      SalesModelData(
        id: id ?? this.id,
  ...
  @override
  int get hashCode => Object.hash(id, status, date, total, userId);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
          ...
          prefetchHooksCallback: ({salesModelRefs = false}) {
            return PrefetchHooks(
              ...
              getPrefetchedDataCallback: (items) async {
                return [
                  if (salesModelRefs)
                    await $_getPrefetchedData<UsersModelData, $UsersModelTable,
                            SalesModelData>(
                        currentTable: table,
              ...
              getPrefetchedDataCallback: (items) async {
                return [
                  if (saleItemsModelRefs)
                    await $_getPrefetchedData<MenuItemModelData,
                            $MenuItemModelTable, SaleItemsModelData>(
                        currentTable: table,
          ...
          prefetchHooksCallback: (
            ...
            return PrefetchHooks(
              ...
              getPrefetchedDataCallback: (items) async {
                return [
                  if (saleItemsModelRefs)
                    await $_getPrefetchedData<SalesModelData, $SalesModelTable,
                            SaleItemsModelData>(
                        currentTable: table,
