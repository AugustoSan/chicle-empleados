...
//     if(index >= 0 && index < menuTabsItems.length) {
//       print('------------------------------------------------------------');
//       print('desde: ${_currentRoute}    ---->   hacia: ${menuTabsItems[index].route}');
//       print('------------------------------------------------------------');
      
//       _currentRoute = menuTabsItems[index].route;
//       _selectedBottomMenuIndex = index;

//       switch (menuTabsItems[index].route) {
//         case '/home':
//           navigatorKey.currentState!.pushNamed(DrawerProducts.home.route);
//           break;
//         case '/menuItems':
//           setSecondRoute('/addMenu');
//           navigatorKey.currentState!.pushNamed(DrawerProducts.products.route);
//           break;
//         case '/orders':
